(function () {
    const dropCardEls = document.querySelectorAll('[data-drop-card-thing]'); // array of all drop card divs
    const cardToggleEls = document.querySelectorAll('[data-drop-card-thing-toggle]'); // array of all toggle buttons
